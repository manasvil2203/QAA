...
# --readFilesIn SRR25630311_1_trimmed_paired.fastq SRR25630311_2_trimmed_paired.fastq \
# --genomeDir Campylomormyrus.compressirostris.dna.dryad.STAR_2.7.11b \
# --outFileNamePrefix STAR_campy
...
--alignIntronMax 1000000 --alignMatesGapMax 1000000 \
--readFilesCommand cat \
--readFilesIn ./SRR25630392_fastq/SRR25630392_1_trimmed_paired.fastq ./SRR25630392_fastq/SRR25630392_2_trimmed_paired.fastq \
--genomeDir Campylomormyrus.compressirostris.dna.dryad.STAR_2.7.11b \
--outFileNamePrefix STAR_campy2